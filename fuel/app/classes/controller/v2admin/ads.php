<?php
class Controller_V2admin_Ads extends Controller_V2admin{
    ...
    public function action_index(){
        ...
        $view = View::forge('v2admin/ads/index');
    ...
    public function action_create() {
        ...
        $view = View::forge('v2admin/ads/create');
        $this->template->set_global('url', Uri::create('v2admin/ads/add'));
    ...
    public function action_add() {
        ...
        Response::redirect('v2admin/ads/create');
    }
    ...
    public function action_edit($id = null) {
        ...
        $this->template->set_global('url', Uri::create('v2admin/ads/update/' . $ad->id));
        $this->template->title = "编辑广告 > 广告列表";
        $this->template->content = View::forge('v2admin/ads/edit');
    ...
    public function action_update($id = null) {
        ...
        Response::redirect('v2admin/ads/edit/'.$id);
    }
