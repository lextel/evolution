<?php
class Controller_V2admin_Ghost extends Controller_V2admin{
    /*
    *
    */
    ...
    */
    public function action_getedit($id = null) {
        ...
        $view = View::forge('v2admin/ghost/edit');
    ...
    */
    ...
    public function action_sell() {
        ...
        $view = View::forge('v2admin/ghost/sell');

        $url = Uri::create('v2admin/ghost/sell');
        $page = new \Helper\Page();
        $config = $page->setConfig($url, $total, 'page');
        $pagination = Pagination::forge('mypagination', $config);
    ...
    public function action_multi()
    {
        ...
        $view = View::forge('v2admin/ghost/multi');
        $breadcrumb = new Helper\Breadcrumb();
        $view->set_global('breadcrumb', $breadcrumb->breadcrumb($breads), false);
        $view->set_global('url', Uri::create('v2admin/ghost/multiUpload'));
