<?php
class Controller_V2admin_Notices extends Controller_V2admin{

    public function action_index() {

        $breads = [
            ['name' => '公告管理'], 
            ['name' => '公告列表', 'href' => Uri::create('v2admin/notices')]
        ];

        $noticeModel = new Model_Notice();
        $total = $noticeModel->countNotice(Input::get());
        $page = new \Helper\Page();
        $url = Uri::create('v2admin/notices', 
        ...
        $view = ViewModel::forge('v2admin/notices/index');
    ...
    public function action_view($id = null) {
        ...
        $view = ViewModel::forge('v2admin/notices/view');
    ...
    public function action_create() {
        ...
        $url = Uri::create('v2admin/notices/add');
        $view = View::forge('v2admin/notices/create');
    ...
    public function action_add() {
        ...
        Response::redirect('v2admin/notices/create');
    }
    ...
    public function action_edit($id = null) {
        ...
        $view = View::forge('v2admin/notices/edit');
        $url = Uri::create('v2admin/notices/update/'.$id);
        $view->set_global('url', $url);
        $breadcrumb = new Helper\Breadcrumb();
        $view->set_global('breadcrumb', $breadcrumb->breadcrumb($breads), false);
    ...
    public function action_update($id = null) {
        ...
        Response::redirect('v2admin/edit/'.$id);
    }
