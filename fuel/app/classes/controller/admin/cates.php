<?php
class Controller_Admin_Cates extends Controller_Admin{
    ...
    public function action_brand() {
        ...
        $url         = Uri::create('/admin/cates/brand');
        ...
        $view = ViewModel::forge('admin/cates/listbrand');
    ...
    public function action_createCate() {
        ...
        Response::redirect('admin/cates/cate');
    }
    ...
    public function action_createBrand() {
        ...
        Response::redirect('admin/cates/brand');
    }
