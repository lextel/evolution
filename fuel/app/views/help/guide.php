...
<div class="guide-fd">
    <div class="column">
        <div class="rule">
            ...
            <p><img src="../assets/img/guide04_16.png" /><span>当一件商品所有“等份”全部售出后计算出的“乐淘码”，拥有“乐淘码“的用户者即可获得此商品。</span></p>
        </div>

        <div class="calculation">
            <div class="title"><img src="../assets/img/guide04_03.png"/><span><b>乐淘码计算方式</b></span></div>
            <p><img src="../assets/img/guide04_07.png" /><span>取消商品最后购买时间前网站所有商品100条购买时间记录（限时揭晓商品取截止时间前网站所有商品100条购买记录）。</span></p>
            <p><img src="../assets/img/guide04_10.png" /><span>时间按时，分，秒毫秒依次排列组成一组数值。</span></p>
            <p><img src="../assets/img/guide04_16.png" /><span>将这100组数值之和除以商品总需参与人次后取余数，余数加上10,000,001即为“乐淘码”。</span></p>
        </div>
    </div>
</div>
