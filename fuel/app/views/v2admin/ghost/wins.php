<div class="panel panel-default" style="padding: 10px 0">
    <form class="navbar-form navbar-left" role="search" action="" method="get">
        ...
        <a href="<?php echo Uri::create('v2admin/ghost/win'); ?>" class="btn btn-default">重置</a>
        <?php echo Html::anchor('v2admin/ghost/create', '添加特殊会员', array('class' => 'btn btn-success pull-right')); ?>
    </form>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <?php echo Html::anchor('v2admin/ghost/gopost/'.$item->member_id, '去晒单', ['onclick' => "return confirm('亲，你确定要去晒单吗?')", 'target'=>'blank', 'class'=>'btn btn-success']); ?>
                <?php }else{?>
                <?php echo '已晒单'; ?>
                <?php } ?>
            </td>
