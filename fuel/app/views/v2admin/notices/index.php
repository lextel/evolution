<div class="panel panel-default" style="padding: 10px 0">
    <form class="navbar-form navbar-left" role="search" action="" method="get">
        ...
        <a href="<?php echo Uri::create('v2admin/notices'); ?>" class="btn btn-default">重置</a>
        <?php echo Html::anchor('v2admin/notices/create', '发布新公告', array('class' => 'btn btn-success pull-right')); ?>
    </form>
...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th class="text-center" width="30%">概要</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <?php echo Html::anchor('v2admin/notices/view/'.$item->id, '查看'); ?> |
                <?php echo Html::anchor('v2admin/notices/edit/'.$item->id, '编辑'); ?> |
                <?php echo Html::anchor('v2admin/notices/delete/'.$item->id, '删除', array('onclick' => "return confirm('亲，真的要删除么?')")); ?>
