        ...
        <div class="W-left fl">
            ...
            <div class="wqyl">
                <div class="wqylL">
                    ...
                    <dl>
                        <h3>一重礼 60银币</h3>
                        您邀请的每一位好友成功参与乐淘，<br>即可获得60银币(100银币等于1元<br>哦！)
                    </dl>
                </div>
                <div class="wqylR">
                    ...
                    <dl>
                        <h3>二重礼 7%的元提成</h3>
                        经您邀请的所有好友，成功参与乐淘<br>后，您都可以获得7%的元奖<br>赏，并且永久有效。
                    </dl>
                </div>
            </div>
...
<?php echo Uri::create('invit/'.base64_encode($current_user->id));?></textarea>
        ...
        <div class="W-right fr">
            ...
            <div class="rig_con">
                <ul>
                    <li><h5>1、在哪里可以看到我的佣金？</h5><p>在【<a href="<?php echo Uri::create('/u'); ?>" target="_blank">用户中心</a>】的【<a href="<?php echo Uri::create('u/brokerage'); ?>" target="_blank">佣金明细</a>】里可看到您的每次返佣记录。佣金满100即会自动转成元，立即可以参与乐淘。</p></li>
