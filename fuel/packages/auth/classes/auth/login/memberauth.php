...
class Auth_Login_Memberauth extends \Auth_Login_Driver
{
	...
	public static function _init()
	{
		...
		if (\Config::get('memberauth.remember_me.enabled', false))
		{
			static::$remember_me = \Session::forge(array(
				...
				'expiration_time' => \Config::get('memberauth.remember_me.expiration', 86400 * 31),
			));
		}
	}
	...
	{
		$username_or_email = trim($username_or_email) ?: trim(\Input::post(\Config::get('memberauth.username_post_key', 'username')));
	...
	public function create_login_hash()
	{
		...
		$login_hash = sha1(\Config::get('memberauth.login_hash_salt').$this->user['username'].$last_login);
