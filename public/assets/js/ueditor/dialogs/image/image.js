        ...
        initUploader: function () {
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if(json.key) {
                        ...
                        var newdata = {
                                "state": "SUCCESS",
                                "url": "http://lltao-intros.qiniudn.com/"+json.key,
                                "title": json.key,
                                "original": json.key
                        };
                        ...
                        $file.find('.error').text(json.error).show();
                    }
            ...
            $upload.on('click', function () {
                ...
                if (state === 'ready') {
                    ...
                    // 七牛
                    $.getJSON('/token', {bucket: 'intros'}, function(data) {
                        if(data.status == 'success') {
                            uploader.options.formData.token = data.token;
                            uploader.upload();
                        }
                    });
